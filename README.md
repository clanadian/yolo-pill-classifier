...
> **아래 학습/데모 파트는 2026-07-28 기준 실제로 동작·수치를 검증했습니다**
...
Jetson Nano 실측 FPS는 초기 5~7fps에서 1분 전후로 3.3~4.3fps로 수렴합니다(3회 독립
실행으로 재현 확인, 열 스로틀링 아님 — 자세한 측정 근거는 `docs/report.md` 6번
항목).
